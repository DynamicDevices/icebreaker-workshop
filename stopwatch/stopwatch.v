...
module top (
	...
	reg [7:0] display_value_ongoing = 0;
	...
	always @(posedge CLK) begin
		...
		if (clkdiv_pulse && running) begin
			display_value <= lap_timeout ? lap_value : display_value_inc;
			display_value_ongoing <= display_value_inc;
...
//	assign display_value_inc = display_value_ongoing + 8'b1;

	// Workshop 3.5
        bcd8_increment bcd8_increment_ctrl (
		.din(display_value_ongoing[7:0]),
		.dout(display_value_inc[7:0])
	);
